...
<head>
    ...
    <link rel="stylesheet" href="{{innkeeperAssets()}}assets/css/pages/auth.css" />
    <link
        rel="shortcut icon"
    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                <div class="auth-logo">
                    <a href="index.html"
                    ><img src="{{innkeeperAssets()}}assets/images/logo/logo.svg" alt="Logo"
                        /></a>
                </div>
                <h4 class="auth-title">Log in.</h4>
                <p class="auth-subtitle mb-5">
                    Welcome to Innkeeper management panel
                </p>

                <form action="{{route('innkeeper.auth.login.post')}}" method="post">
                    @csrf
